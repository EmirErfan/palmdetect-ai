  ...
  return (
    <div className="hide-scrollbar" style={{ background: 'var(--bg)', minHeight: '100%' }}>
      ...
      <div style={{
        ...
        <div style={{ position: 'absolute', top: 20, right: 50, width: 80, height: 80, borderRadius: '50%', background: 'rgba(255,255,255,0.05)' }} />
        ...
        <div className="flex justify-between items-start relative z-10">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 style={{ fontFamily: "'DM Serif Display', serif", fontSize: '22px', fontWeight: 400, color: 'white', letterSpacing: '-0.3px', lineHeight: 1.1 }}>
                PalmDetect AI
              </h1>
          ...
          <div className="flex items-center">
            <div style={{ width: '48%', height: 120 }}>
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie data={distributionData} innerRadius={36} outerRadius={52} paddingAngle={3} startAngle={90} endAngle={-270} dataKey="value" strokeWidth={0}>
